...
// USA
// 
/* $Id: drqm_jobs_lightwave.h 1165 2005-02-18 16:10:06Z kraken $ */

#ifndef _DRQM_JOBS_LIGTHWAVE_H_
#define _DRQM_JOBS_LIGTHWAVE_H_

#include <gtk/gtk.h>

#ifdef __CYGWIN
#define KOJ_LIGHTWAVE_DFLT_VIEWCMD "tif"
#else
#define KOJ_LIGHTWAVE_DFLT_VIEWCMD "fcheck $DRQUEUE_RD/$DRQUEUE_IMAGE.$DRQUEUE_PADFRAME.tif"
#endif
