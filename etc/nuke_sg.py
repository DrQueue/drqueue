...
# 
# Default configuration for Nuke script generator
# 
# Python variables
# SCENE, RF_OWNER, FFORMAT, RESX, RESY, CAMERA
# 
# shell variables
...
command = ENGINE_PATH+" -x "+SCENE+" "+str(DRQUEUE_FRAME)+" "+str(BLOCK)+" "+str(DRQUEUE_STEPFRAME)
