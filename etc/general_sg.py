...
if DRQUEUE_OS == "WINDOWS":
	...
	GENSCRIPT = subprocess.Popen(["cygpath.exe", "-w "+GENSCRIPT], stdout=subprocess.PIPE).communicate()[0]
...
command = GENSCRIPT+" "+str(DRQUEUE_FRAME)
